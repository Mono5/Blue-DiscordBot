...
log = logging.getLogger("blue.owner")
...
class Owner:
    ...
    def __init__(self, bot):
        ...
        self.disabled_commands = dataIO.load_json("data/blue/disabled_commands.json")
    ...
    async def owner(self, ctx):
        ...
        if self.bot.settings.no_prompt is True:
            await self.bot.say("Console interaction is disabled. Start Blue "
    ...
    async def serverprefix(self, ctx, *prefixes):
        """Sets Blue's prefixes for this server
    ...
    async def _blacklist_add(self, user: GlobalUser):
        """Adds user to Blue's global blacklist"""
    ...
    async def _blacklist_remove(self, user: GlobalUser):
        """Removes user from Blue's global blacklist"""
    ...
    async def _whitelist_add(self, user: GlobalUser):
        """Adds user to Blue's global whitelist"""
    ...
    async def _whitelist_remove(self, user: GlobalUser):
        """Removes user from Blue's global whitelist"""
    ...
    def _get_version(self):
        if not os.path.isdir(".git"):
            msg = "This instance of Blue hasn't been installed with git."
    ...
    def save_disabled_commands(self):
        dataIO.save_json("data/blue/disabled_commands.json", self.disabled_commands)
